...
RUST_BACKTRACE=full RUST_LOG=wgpu_hal=debug cargo so b --target aarch64-linux-android 
RUST_BACKTRACE=full RUST_LOG=wgpu_hal=debug cargo so b --target armv7-linux-androideabi
